...
class TestMetaClassIttrMultiplayer(object):
    ...
    def test_self_modification_by_test_method(self):
        ...
        """
        self.test_class.test_method_9_val_b_val_c()
        ok_(hasattr(self.test_class, 'attr_one'))
        ok_(hasattr(self.test_class, 'attr_two'))
    ...
    def test_mirror_methods_suffix_name_creation(self):
        ...
        """
        ok_(hasattr(self.test_class, 'test_method_1'))
        ok_(hasattr(self.test_class, 'test_method_2'))
        ok_(hasattr(self.test_class, 'test_method_3'))
        ok_(hasattr(self.test_class, 'test_method_4'))
        ok_(hasattr(self.test_class, 'test_method_5'))
        ok_(hasattr(self.test_class, 'test_method_6_val_a'))
        ok_(hasattr(self.test_class, 'test_method_7_val_a_val_c'))
        ok_(hasattr(self.test_class, 'test_method_7_val_b_val_c'))
        ok_(hasattr(self.test_class, 'test_method_7_val_b_val_c'))
        ok_(hasattr(self.test_class, 'test_method_8_val_a_val_b_val_c'))
        ok_(hasattr(self.test_class, 'test_method_8_val_a_val_b_val_d'))
        ok_(hasattr(self.test_class, 'test_method_9_val_a_val_c'))
        ok_(hasattr(self.test_class, 'test_method_9_val_b_val_c'))
        ok_(hasattr(self.test_class, 'test_method_9_val_b_val_c'))
        ok_(hasattr(self.test_class, 'test_method_10_val_a_val_d_val_b'))
        ok_(hasattr(self.test_class, 'test_method_11_val_a__'))
    ...
    def test_ittr_product_method_number(self):
        ...
        """
        res = filter(lambda x: 'test' in x or None, dir(self.test_class))
    ...
    def test_original_method_has_notest_hook(self):
        ...
        """
        assert_false(self.test_class.test_method_1.__test__)
        assert_false(self.test_class.test_method_2.__test__)
        assert_false(self.test_class.test_method_3.__test__)
        assert_false(self.test_class.test_method_6.__test__)
        assert_false(self.test_class.test_method_7.__test__)
        assert_false(self.test_class.test_method_8.__test__)
        assert_false(self.test_class.test_method_9.__test__)
        assert_false(self.test_class.test_method_10.__test__)
        assert_false(self.test_class.test_method_11.__test__)
